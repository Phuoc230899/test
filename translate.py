...
def get_parser():
    ...
    parser.add_argument("--model_path", type=str,
                        default="model_2.pth", help="Model path")
    ...
    parser.add_argument("--BPE_path", type=str,
                        default="Convert/data/BPE_with_comments_codes", help="Path to BPE codes.")
...
if __name__ == '__main__':
    ...
    with torch.no_grad():
        output = translator.translate(
            input1, lang1=params.src_lang, lang2=params.tgt_lang, beam_size=params.beam_size)
